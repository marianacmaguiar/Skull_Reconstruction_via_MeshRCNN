...
from mask import batch_crop_masks_within_box
...
def mask_rcnn_loss(pred_mask_logits, instances):
    ...
    #print("Total_num_masks exist? Line 29 from mask_head.py: ", total_num_masks) == 6
    #print("Mask_side_len exists? Line 30 from mask_head.py: ", mask_side_len) == 28
